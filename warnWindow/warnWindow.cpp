...
int APIENTRY wWinMain(_In_ HINSTANCE hInstance,
                     ...
                     _In_ int       nCmdShow)
{
    const wchar_t szUniqueNamedMutex[] = L"warnWindow";
    ...
    LoadStringW(hInstance, IDC_WARNWINDOW, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_WARNWINDOW));
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   CreateWindow(
       ...
       TEXT("Пожалуйста, выберите в выпадающем списке в строке состояния ваш рабочий набор (начинается на \"02\")"),
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    {
    case WM_CREATE:
        hBitmap = (HBITMAP)LoadImage(GetModuleHandle(NULL), MAKEINTRESOURCE(IDB_BITMAP_WORKSET), IMAGE_BITMAP, 0, 0, 0);
        break;
